...
export const mockOrders: Order[] = [
  ...
  { id: '1006', customerName: 'Mariana Lima', items: [{ productName: 'Pizza de Calabresa', quantity: 1, size: 'pequeno' }, { productName: 'Coca-Cola 2L', quantity: 1 }], total: 45.50, status: 'Preparando', timestamp: '10:42', orderType: 'entrega', address: 'Avenida Beira Mar, 456, Centro, Rio de Janeiro - RJ' },
