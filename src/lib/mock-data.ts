...
export const mockOrders: Order[] = [
  ...
  { id: '1004', customerName: 'Ana Costa', items: [{ productName: 'Pizza de Frango com Catupiry', quantity: 1, size: 'grande' }], total: 59.90, status: 'Em Entrega', timestamp: '10:40', orderType: 'entrega', locationLink: 'https://maps.app.goo.gl/examplelink1', notes: 'Deixar na portaria com o Sr. Valdir.' },
