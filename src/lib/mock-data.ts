...
export const mockProducts: Product[] = [
  ...
  // Bebidas
  { id: '4', name: 'Coca-Cola', category: 'Bebida', sizes: { '2L': 12.00, 'Lata 350ml': 6.00 }, isAvailable: true },
  { id: '7', name: 'Guaraná Antarctica', category: 'Bebida', sizes: { '2L': 12.00, 'Lata 350ml': 6.00 }, isAvailable: true },
  { id: '8', name: 'Fanta Laranja', category: 'Bebida', sizes: { '2L': 12.00 }, isAvailable: false },
  { id: '11', name: 'Água Mineral', category: 'Bebida', sizes: { '500ml': 4.00 }, isAvailable: true },
...
export const mockOrders: Order[] = [
  ...
  { id: '1005', customerName: 'Lucas Souza', items: [{ productName: 'Coca-Cola', quantity: 1, size: '2L' }], total: 12.00, status: 'Entregue', timestamp: '10:25', orderType: 'retirada' },
  { id: '1006', customerName: 'Mariana Lima', customerPhone: '(11) 91234-5678', items: [{ productName: 'Pizza de Calabresa', quantity: 1, size: 'pequeno' }, { productName: 'Coca-Cola', quantity: 1, size: '2L' }], total: 47.5, status: 'Preparando', timestamp: '10:42', orderType: 'entrega', address: 'Avenida Beira Mar, 456, Centro, Rio de Janeiro - RJ' },
